...
#BSP: add lcm driver LEQHLJQ-1 by mingyuan.sun 20201214 start
BOOT_LOGO = fhdplus2460
#BSP: add lcm driver LEQHLJQ-1 by mingyuan.sun 20201214 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wanghanfeng 20201015 start
CUSTOM_BUILD_VERNO = CY-LE7-H697-G
#BSP: add project macro by wanghanfeng 20201015 start
...
CUSTOM_HAL_IMGSENSOR = s5kgm1st_mipi_raw s5kgm1stext2_mipi_raw gc8034_mipi_raw ov8856ff_mipi_raw gc08a3_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc02m1_mipi_raw ov02b10_mipi_raw gc6153_serial_yuv pblcs5kgm1st_mipi_raw pblcs5kgm1stext2_mipi_raw pblcgc8034_mipi_raw pblcov8856ff_mipi_raw pblcgc08a3_mipi_raw pblcgc02m1b_mipi_raw pblcov02b1b_mipi_raw pblcgc02m1_mipi_raw pblcov02b10_mipi_raw pblcgc6153_serial_yuv
...
#ITD:modify by camera driver team en
#BSP: add LEQHLJQ-4 by kangping.liu for 20201216 start
TRAN_SINGLE_ALS_CALI = yes
CUSTOM_HAL_MSENSORLIB =
#BSP: add LEQHLJQ-4 by kangping.liu for 20201216 end
CUSTOM_HAL_SENSORS = sensor
#ITD:modify by camera driver team start
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw ov8856ff_mipi_raw gc08a3_mipi_raw
...
#BSP: add LEQHLJQ-4 by kangping.liu for 20201216 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5kgm1st_mipi_raw s5kgm1stext2_mipi_raw gc8034_mipi_raw ov8856ff_mipi_raw gc08a3_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc02m1_mipi_raw ov02b10_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
#BSP: add LEQHLJQ-4 by kangping.liu for 20201216 end
#ITD:modify by camera driver team start
CUSTOM_TRAN_KERNEL_MAIN4_IMGSENSOR = gc6153_serial_yuv
CUSTOM_TRAN_KERNEL_MAIN3_IMGSENSOR = gc02m1_mipi_raw ov02b10_mipi_raw
...
#ITD:modify by camera driver team end
#BSP: add CGQHLJQ-2 by zhi.chen for 20201120 start
CUSTOM_KERNEL_MOTION_DETECT = yes
CUSTOM_KERNEL_ORIENTATION_SENSOR = yes
#BSP: add CGQHLJQ-2 by zhi.chen for 20201120 end
...
#BSP: add LEQHLJQ-4 by kangping.liu for 20201216 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc8034_mipi_raw ov8856ff_mipi_raw gc08a3_mipi_raw
#ITD:modify by camera driver team end
...
#TSD:modify CMSFTASK-16 by chaochao.he 20210104 start
CUSTOM_MODEM=le7_h697_g1
#TSD:modify CMSFTASK-16 by chaochao.he 20210104 end
...
# BSP:modify audio bring up XLJSHLJQ-6 shuanglei.wang 20201113 start
MTK_AUDIO_NUMBER_OF_MIC = 1
# BSP:modify audio bring up XLJSHLJQ-6 shuanglei.wang 20201113 end
...
MTK_BWC_SUPPORT = yes
#TSD:modify CMSFTASK-16 by chaochao.he 20201119 start
MTK_C2K_LTE_MODE = 0
#TSD:modify CMSFTASK-16 by chaochao.he 20201119 end
MTK_CAMERA_APP = no
...
#ITD:add cam 3pty function by yu.wang 20201130 start
MTK_CAM_HDR_SUPPORT = no
#ITD:add cam 3pty function by yu.wang 20201130 end
...
#BSP:modify charge function XLJLHLJY-1249 by fan.hong 20201216 start
MTK_DUAL_CHARGER_SUPPORT = yes
#BSP:modify charge function XLJLHLJY-1249 by fan.hong 20201216 end
...
#TSD:modify fm antenna LEQHLJQ-6 by huijun.shen 20201221 start
MTK_FM_SHORT_ANTENNA_SUPPORT = yes
#TSD:modify fm antenna LEQHLJQ-6 by huijun.shen 20201221 end
MTK_FM_SUPPORT = yes
...
#BSP:modify charge function XLJLHLJY-1249 by fan.hong 20201119 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify charge function XLJLHLJY-1249 by fan.hong 20201119 end
MTK_K64_SUPPORT=yes
...
MTK_TOUCHPANEL_KO =
#BSP: add project clone format by wanghanfeng 20201015 start
...
#BSP: add project clone format by wanghanfeng 20201015 end
#SDD: add project sw version by jiangping.guo 20201015 start
MTK_BUILD_VERNO=LE7-H697GHIJKL-R-GL-220610V523
TRAN_FINGERPRINT_BUILD_VERNO=220610V523
#SDD: add project sw version by jiangping.guo 20201015 end
#BSP: add project macro by wanghanfeng 20201015 start
CUSTOM_TRAN_PROJECT=tran_le7
CUSTOM_TRAN_BOM=tran_le7_g1
#BSP: add project macro by wanghanfeng 20201015 end
